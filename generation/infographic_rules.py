...
- ICON STYLE: simple flat monochrome line or solid-glyph icons only (a Bluetooth glyph, a USB glyph, a microphone, a stopwatch, a water drop) — never colourful cartoon icons, never emoji, never 3D or photo-realistic icon renders. One icon colour per card (usually the accent colour or white), matched to the same small caption (1-3 words) beside it, not a longer description.
